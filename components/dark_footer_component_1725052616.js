          ...
          <ul id="footer-block-2-list" class="text-sm space-y-2">
            ...
            <li>
              <a
                ...
                href="#0"
              >
                Join the digital cat revolution
              </a>
            </li>
          </ul>
        </div>
...
<script>
export default {
  name: "dark_footer_component_1725052616",
  data() {
    return {
      expanded: false,
      tab: null,
